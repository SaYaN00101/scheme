...
-- Complete Database Schema with ALL Schemes (Central + West Bengal State)
-- Total: 149 scheme records (deduplicated)
-- Run: mysql -u root -p < all_schemes_complete.sql
...
-- ==========================================
-- ADDITIONAL WEST BENGAL STATE SCHEMES (from myScheme API)
-- 103 schemes (4 duplicates already present above were skipped)
-- ==========================================
-- 1. Pratyasha Scheme- West Bengal
...
-- 2. Bina Mulya Samajik Suraksha Yojana
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 4. Medical Expenses-Treatment for Major Ailments Including Surgery
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 5. West Bengal Transport Workers’ Social Security Scheme: Assistance on Death and Permanent Disablement
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 8. Old Age Pension To Handloom Weavers Under Coop. Fold
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 11. West Bengal Student Credit Card Scheme
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 12. Disability Pension - West Bengal
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 15. West Bengal Migrant Workers’ Welfare Scheme: Death Assistance
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 16. West Bengal Migrant Workers’ Welfare Scheme: Repatriation of Dead Body
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 17. West Bengal Migrant Workers’ Welfare Scheme: Cremation
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 18. West Bengal Artisans Financial Benefit Scheme 2024: Grant to Industrial Cooperative Society
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 19. West Bengal Artisans Financial Benefit Scheme: Facilitation Supports
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 23. Tool Purchase Grant for the Construction Workers
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 25. Financial Assistance for Education of Self/ Children of Beneficiaries 
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 26. Cost of Spectacle for the Construction Workers  
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 27. Cost of Hearing Aid for the Construction Workers
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 28. West Bengal Transport Workers’ Social Security Scheme: Assistance for Purchase of Spectacles
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 29. West Bengal Transport Workers’ Social Security Scheme: Pension
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 33. Jai Johar (Old Age Pension) Scheme
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 34. Toposili Bandhu (Old Age Pension) Scheme
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 37. Funeral Expenses for the Construction Workers
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 38. West Bengal Transport Workers’ Social Security Scheme: Family Pension
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 39. West Bengal Freeship Scheme
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 41. West Bengal Migrant Workers’ Welfare Scheme: Accidental Disability
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 42. West Bengal Artisans Financial Benefit Scheme 2024: Grant to Individual Artisans
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 43. West Bengal Handloom and Khadi Weavers Financial Benefit Scheme 2024: Assistance to Individual Handloom Weaver
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 44. Refund of Subscriptions for the Construction Workers
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 45. West Bengal Transport Workers’ Social Security Scheme: Assistance on Hospitalization
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 46. State Welfare Scheme For Purohits
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 47. West Bengal Transport Workers’ Social Security Scheme: Assistance for Education of Children
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 49. Scheme of Death Benefit for Weavers & Artisans of West Bengal
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 50. West Bengal Transport Workers’ Social Security Scheme: Medical Benefit for Major Ailments
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 51. West Bengal Transport Workers’ Social Security Scheme: Funeral Expenses
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 54. West Bengal Transport Workers’ Social Security Scheme: Assistance for Marriage
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 55. West Bengal Transport Workers’ Social Security Scheme: Maternity Benefit
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 57. Banglashree for Micro, Small and Medium Enterprises: Interest Subsidy on Term Loan (IS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 58. Banglashree for Micro, Small and Medium Enterprises: Subsidy for Work Force Welfare Assistance (WWAS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 59. The West Bengal Incentive Scheme: Additional Incentive on Generation of Employment
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 60. The West Bengal Incentive Scheme: Interest Subsidy on Term Loan
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 61. West Bengal Textile Incentive Scheme: Incentive for Energy Efficiency
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 62. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy on Stamp Duty and Registration Fees
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 63. Credit Linked Subsidy Scheme for Rural Entrepreneurs to set up Custom Hiring Centres (CHC) of Farm Machinery
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 64. Farm Machinery Bank (FMB)/Farm Machinery Hub (FMH)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 65. West Bengal Textile Incentive Scheme: Subsidy for Water conservation/ Environment Compliance
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 66. West Bengal Textile Incentive Scheme: Waiver of Fees for Land Conversion and Mutation
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 67. The West Bengal Incentive Scheme: Reimbursement of Stamp Duty and Registration Fee
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 68. West Bengal Artisans Financial Benefit Scheme: Support for Digital Marketing
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 69. West Bengal Textile Incentive Scheme: Waiver of Electricity Duty
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 70. West Bengal Textile Incentive Scheme: State Capital Investment Subsidy
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 71. Incentive Scheme for MSMEs in Powerloom Sector: Work Force Welfare Assistance
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 72. Incentive Scheme for MSMEs in Powerloom Sector: State Capital Investment Subsidy
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 73. West Bengal Incentive Scheme for Approved Industrial Park (SAIP) for MSMEs: Reimbursement of Stamp Duty
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 74. West Bengal Incentive Scheme for Approved Industrial Park (SAIP) for MSMEs: Incentive for Basic and Essential Common Infrastructure Facilities
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 75. One Time Assistance to Small and Marginal Farmers for Purchase of Small Farm Implements (OTA-SFI)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 76. Banglashree for Micro, Small and Medium Enterprises: Subsidy for Energy Efficiency (EES)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 77. The West Bengal Incentive Scheme: Waiver of Electricity Duty
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 78. The West Bengal Incentive Scheme: State Capital Investment Subsidy
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 79. Banglashree for Micro, Small and Medium Enterprises: Subsidy on Stamp Duty and Registration Fee (SDRFS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 80. Incentive Scheme for MSMEs in Powerloom Sector: Interest Subsidy on Term Loan
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 81. Incentive Scheme for MSMEs in Powerloom Sector: Waiver of Electricity Duty
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 82. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy for State Goods and Services Tax (SGST)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 83. The West Bengal Incentive Scheme: Additional Incentive for Adventure Tour Operators
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 84. West Bengal Handloom and Khadi Weavers Financial Benefit Scheme 2024: Supply of Yarn to Societies etc. at Subsidized Rate
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 85. The West Bengal Incentive Scheme: Tourism Promotion Assistance in lieu of Interest Subsidy
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 86. West Bengal Incentive Scheme for Approved Industrial Park (SAIP) for MSMEs: Incentive for Setting up a Power Sub Station
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 87. Banglashree for Micro, Small and Medium Enterprises: Power Subsidy (PS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 88. Banglashree for Micro, Small and Medium Enterprises: Subsidy for Water Conservation/Environment Compliance (WCS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 89. West Bengal Handloom and Khadi Weavers Financial Benefit Scheme 2024: Support for One Time Settlement (OTS) of NPA Accounts of PWCS
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 90. The West Bengal Incentive Scheme: Subsidy for Quality Improvement
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 91. West Bengal Textile Incentive Scheme: Power Subsidy
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 92. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy for Standard Quality Compliance
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 93. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy for Patent Registration
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 94. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy for Energy Efficiency
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 95. West Bengal Incentive Scheme for Approved Industrial Park (SAIP) for MSMEs: Construction of Approach Road
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 96. The West Bengal Incentive Scheme: Capacity Utilisation
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 97. Financial Support Scheme for Farm Mechanization (FSSM)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 98. Banglashree for Micro, Small and Medium Enterprises: Subsidy for Standard Quality Compliance (SCCS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 99. Banglashree for Micro, Small and Medium Enterprises: State Capital Investment Subsidy (CIS)
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 100. West Bengal Handloom and Khadi Weavers Financial Benefit Scheme 2024: Assistance to Viable and Potentially Viable PWCS
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 101. Incentive Scheme for MSMEs in Powerloom Sector: Subsidy for Water Conservation/ Environment Compliance
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
...
-- 102. West Bengal Textile Incentive Scheme: Reimbursement of Stamp Duty and Registration Fee
INSERT INTO schemes (category_id, name, description, scope, state, min_age, max_age, gender, max_income, occupation, education_level, caste_category, benefit_details, documents_required, application_url, deadline, is_active)
